...
def create_oxidizer_tank():
    ...
    oxidizer_liq = Fluid(
        name=cfg["fuels"]["liquid"]["name"],
        density=cfg["fuels"]["liquid"]["density"],
    )
    oxidizer_gas = Fluid(
        name=cfg["fuels"]["gas"]["name"],
        density=cfg["fuels"]["liquid"]["density"],
    )
    # Get tank geometry
    ...
    oxidizer_tank = MassFlowRateBasedTank(
        ...
        liquid_mass_flow_rate_in=cfg["tank"]["oxidizer_tank"][
            "liquid_mass_flow_rate_in"
        ],
        liquid_mass_flow_rate_out=cfg["tank"]["oxidizer_tank"][
            "liquid_mass_flow_rate_out"
        ],
        gas_mass_flow_rate_in=cfg["tank"]["oxidizer_tank"][
            "gas_mass_flow_rate_in"
        ],
        gas_mass_flow_rate_out=cfg["tank"]["oxidizer_tank"][
