...
class AV_TO_GCS_DATA_2 {
 public:
  ...
  payload::AV_TO_GCS_DATA_2_FlightState flight_state() const {
 ...
 private:
  ...
  static payload::AV_TO_GCS_DATA_2_FlightState calc_flight_state(
      unsigned int val) {
    // Also I know this can be returned implicitly, but this is self documenting
    switch (val) {
      case 0b000:
        return payload::AV_TO_GCS_DATA_2_FlightState::
            AV_TO_GCS_DATA_2_FlightState_PRE_FLIGHT_NO_FLIGHT_READY;
      case 0b001:
        return payload::AV_TO_GCS_DATA_2_FlightState::
            AV_TO_GCS_DATA_2_FlightState_PRE_FLIGHT_FLIGHT_READY;
      case 0b010:
        return payload::AV_TO_GCS_DATA_2_FlightState::
            AV_TO_GCS_DATA_2_FlightState_LAUNCH;
      case 0b011:
        return payload::AV_TO_GCS_DATA_2_FlightState::
            AV_TO_GCS_DATA_2_FlightState_COAST;
      case 0b100:
        return payload::AV_TO_GCS_DATA_2_FlightState::
            AV_TO_GCS_DATA_2_FlightState_APOGEE;
      case 0b101:
        return payload::AV_TO_GCS_DATA_2_FlightState::
            AV_TO_GCS_DATA_2_FlightState_DECENT;
      case 0b110:
        return payload::AV_TO_GCS_DATA_2_FlightState::
            AV_TO_GCS_DATA_2_FlightState_LANDED;
      case 0b111:
        return payload::AV_TO_GCS_DATA_2_FlightState::
            AV_TO_GCS_DATA_2_FlightState_OH_NO;
      default:
        slogger::error("Unexpected flight state case bits in AV_TO_GCS_DATA_2");
