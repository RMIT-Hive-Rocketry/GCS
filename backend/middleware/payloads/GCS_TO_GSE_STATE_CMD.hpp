...
#include "GCS_TO_GSE_STATE_CMD.pb.h"
...
class GCS_TO_GSE_STATE_CMD {
 public:
  ...
  bool manual_purge_activate_inverted() const {
    return manual_purge_activate_inverted_;
  }
  bool o2_fill_activate_inverted() const { return o2_fill_activate_inverted_; }
  bool selector_switch_neutral_position_inverted() const {
    return selector_switch_neutral_position_inverted_;
  }
  bool n20_fill_activate_inverted() const {
    return n20_fill_activate_inverted_;
  }
  bool ignition_fire_inverted() const { return ignition_fire_inverted_; }
  bool ignition_selected_inverted() const {
    return ignition_selected_inverted_;
  }
  bool gas_fill_selected_inverted() const {
    return gas_fill_selected_inverted_;
  }
