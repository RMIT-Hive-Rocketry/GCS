...
from rocket import (
    _validate_interface_options,  # pyright: ignore[reportPrivateUsage]
)


def test_validate_interface_options_valid_single() -> None:
...
def test_validate_interface_options_valid_dual() -> None:
...
def test_validate_interface_options_valid_all_none() -> None:
    """All None means use config (single interface from config)."""
    _validate_interface_options(None, None, None)


def test_validate_interface_options_invalid_single_and_av() -> None:
...
def test_validate_interface_options_invalid_single_and_gse() -> None:
...
def test_validate_interface_options_invalid_only_av() -> None:
...
def test_validate_interface_options_invalid_only_gse() -> None:
...
def test_validate_interface_options_invalid_all_three() -> None:
