...
/// @param INTERFACE_NAME One of "UART_E5", "UART_FEATHER", "TEST",
/// "TEST_UART_E5", "TCP"
/// @param DEVICE_PATH Device path or endpoint (e.g. /dev/serial0, /dev/pts/X,
/// ip:port)
/// @param lora_cfg Required for UART_E5 and UART_FEATHER (which only uses the
/// frequency and power fields); ignored for other types
