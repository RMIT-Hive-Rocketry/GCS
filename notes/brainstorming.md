...
- System will receive data from ISA or I2C

## Non-Functional Requirements

- Server can be accessible through a router and viewed from other people's devices
...
- Web server accessible by control room for livestream accesability
...
Note, broadcast HUD can be transparent web page overlaid on broadcast software with video source for live output visualisation.


Now I'm thinking we use unix sockets to just talk from the ingestion system to the web server. This is designed for inter-process communication and runs on memory instead of disk. Then cache data on the web server runtime so you can distribute to clients closer to the data source

### Development and production environment ideas

- Docker for development and native for production
	- I want to be able to pick this up on any machine and just have it work. for development at least. Docker overhead cannot be afforded in production.
...
- Vue TS
	...
	- Probably won't use many features, but this is a good foundation.
- Tailwind CSS
	- To look cool
- Three.js
