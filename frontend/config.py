...
class LegacyConfig(Config):
    ...
    MODULES = {
        ...
        "modules/legacy3_hmi.html": {"pages": [["page-hmi", 0, 0, 12, 12]]},
        ...
        "modules/legacy3_ops_auxcontrols.html": {
            "pages": [["page-ops", 4, 6, 4, 6]]
        },
        "modules/legacy3_ops_continuitycheck.html": {
            "pages": [["page-ops", 0, 0, 4, 6]]
        },
        "modules/legacy3_ops_poptest.html": {
            "pages": [["page-ops", 0, 6, 4, 6]]
        },
        "modules/legacy3_ops_systemflags.html": {
            "pages": [["page-ops", 8, 0, 4, 12]]
        },
        "modules/legacy3_rocket.html": {"pages": [["page-main", 4, 0, 4, 9]]},
...
class AtlasConfig(Config):
    ...
    MODULES = {
        "modules/atlas_avionics.html": {"pages": [["page-main", 0, 0, 4, 7]]},
        "modules/atlas_indicators.html": {"pages": [["page-main", 8, 0, 4, 2]]},
        "modules/atlas_position.html": {"pages": [["page-main", 0, 7, 4, 5]]},
        "modules/atlas_payload.html": {"pages": [["page-main", 8, 2, 4, 6]]},
        "modules/atlas_rocket.html": {"pages": [["page-main", 4, 0, 4, 9]]},
        "modules/atlas_timeline.html": {"pages": [["page-main", 4, 9, 4, 3]]},
        "modules/module_errorlog.html": {"pages": [["page-main", 8, 8, 4, 4]]},
    }
