...
| Accel X          | _g_   | 3      | `accelLowX, accelHighX`                     | `av-accel-x`         |
| Accel Y          | _g_   | 3      | `accelLowY, accelHighY`                     | `av-accel-y`         |
| Accel Z          | _g_   | 3      | `accelLowZ, accelHighZ`                     | `av-accel-z`         |
...
| Name            | Unit        | API ID | API key        | ID                  |
| --------------- | ----------- | ------ | -------------- | ------------------- |
| AV comms state  | _bool_      |        |                | `radio-av-state`    |
| AV RSSI         | dBm [0,255] | 3,4,5  | `meta.rssi`    | `radio-av-rssi`     |
| AV SNR          | dB          | 3,4,5  | `meta.snr`     | `radio-av-snr`      |
| AV Packets      | _int_       | 3,4,5  | `meta.packets` | `radio-av-packets`  |
| GSE comms state | _bool_      |        |                | `radio-gse-state`   |
| GSE RSSI        | dBm [0,255] | 6,7    | `meta.rssi`    | `radio-gse-rssi`    |
| GSE SNR         | dB          | 6,7    | `meta.snr`     | `radio-gse-snr`     |
| GSE Packets     | _int_       | 6,7    | `meta.packets` | `radio-gse-packets` |
